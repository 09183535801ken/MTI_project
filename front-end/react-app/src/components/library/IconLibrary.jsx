...
// Helper wrapper for the gradient circle
const GradientCircleWrapper = ({ children, className }) => (
  <div className={`gradient-circle-icon ${className}`}>
    {children}
  </div>
);

// Font Awesome Vessel Icon
export const VesselIcon = (props) => (
  <GradientCircleWrapper className="icon-vessel">
    <svg 
      xmlns="http://www.w3.org/2000/svg" 
      viewBox="0 0 640 640" 
      fill="white" 
...
// Font Awesome People Icon
export const PeopleIcon = (props) => (
  <GradientCircleWrapper className="icon-people">
    <svg 
      xmlns="http://www.w3.org/2000/svg" 
      viewBox="0 0 640 640" 
      fill="white"
...
// Font Awesome Training/Compass Icon
export const TrainingIcon = (props) => (
  <GradientCircleWrapper className="icon-training">
    <svg 
      xmlns="http://www.w3.org/2000/svg" 
      viewBox="0 0 640 640" 
      fill="white"
