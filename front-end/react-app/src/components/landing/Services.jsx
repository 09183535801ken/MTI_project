...
function Services() {
    ...
    return (
        <section id="services" className="services-section">
            ...
            <div className="services-header-container scroll-reveal" ref={reveal}>
                <span className="services-eyebrow">Professional Development</span>
                <h2 className="services-main-title">Key <span>Services.</span></h2>
